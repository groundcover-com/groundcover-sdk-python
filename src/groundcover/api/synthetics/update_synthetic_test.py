...
) -> ErrorResponse | SyntheticTestUpdateResponse | None:
    if response.status_code == 200:
        response_200 = SyntheticTestUpdateResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | SyntheticTestUpdateResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | SyntheticTestUpdateResponse
    """
