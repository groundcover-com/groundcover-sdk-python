...
) -> ErrorResponse | SyntheticTestCreateResponse | None:
    if response.status_code == 201:
        response_201 = SyntheticTestCreateResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | SyntheticTestCreateResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | SyntheticTestCreateResponse
    """
