...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/integrations/v1/data/config/{type_}".format(
...
) -> ErrorResponseIsTheCanonicalErrorBodyReturnedByHTTPHandlers | list[DataIntegrationConfig] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponseIsTheCanonicalErrorBodyReturnedByHTTPHandlers | list[DataIntegrationConfig]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponseIsTheCanonicalErrorBodyReturnedByHTTPHandlers | list[DataIntegrationConfig]
    """
