...
) -> ErrorResponseIsTheCanonicalErrorBodyReturnedByHTTPHandlers | LogsPipelineConfig | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponseIsTheCanonicalErrorBodyReturnedByHTTPHandlers | LogsPipelineConfig]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponseIsTheCanonicalErrorBodyReturnedByHTTPHandlers | LogsPipelineConfig
    """
