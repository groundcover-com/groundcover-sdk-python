...
T = TypeVar("T", bound="RouteConnectedAppRequestParams")
...
class RouteConnectedAppRequestParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        route_connected_app_request_params = cls()

        route_connected_app_request_params.additional_properties = d
        return route_connected_app_request_params
