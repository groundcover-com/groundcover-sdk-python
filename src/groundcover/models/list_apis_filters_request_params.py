...
T = TypeVar("T", bound="ListApisFiltersRequestParams")


@_attrs_define
class ListApisFiltersRequestParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_apis_filters_request_params = cls(
        ...
        list_apis_filters_request_params.additional_properties = d
        return list_apis_filters_request_params
