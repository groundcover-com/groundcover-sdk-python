...
T = TypeVar("T", bound="TracesRequest")
...
class TracesRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        order_by: SearchOrderByDefinesTheOrderForASearchPipeline | Unset
        if isinstance(_order_by, Unset) or _order_by is None:
            order_by = UNSET
        else:
            order_by = SearchOrderByDefinesTheOrderForASearchPipeline.from_dict(_order_by)
        ...
        traces_request.additional_properties = d
        return traces_request
