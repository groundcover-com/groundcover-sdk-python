...
T = TypeVar("T", bound="TracesSearchOverTimeStreamResponse")


@_attrs_define
class TracesSearchOverTimeStreamResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traces_search_over_time_stream_response = cls(
            data=data,
            done=done,
            error=error,
            estimate=estimate,
        ...
        traces_search_over_time_stream_response.additional_properties = d
        return traces_search_over_time_stream_response
