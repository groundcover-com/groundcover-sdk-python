...
T = TypeVar("T", bound="LogsPipelineConfig")


@_attrs_define
class LogsPipelineConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logs_pipeline_config.additional_properties = d
        return logs_pipeline_config
