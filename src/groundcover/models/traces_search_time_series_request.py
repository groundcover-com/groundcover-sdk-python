...
T = TypeVar("T", bound="TracesSearchTimeSeriesRequest")


@_attrs_define
class TracesSearchTimeSeriesRequest:
    """
    Attributes:
        ...
        filters (str | Unset): Extra filters to apply on the traces
        ...
        query (str | Unset): GCQL Query to filter traces
        sources (list[ConditionSpecifiesASearchConditionBasedOnAColumnAndFilters] | Unset): Sources to filter traces
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traces_search_time_series_request = cls(
            end=end,
            start=start,
        ...
        traces_search_time_series_request.additional_properties = d
        return traces_search_time_series_request
