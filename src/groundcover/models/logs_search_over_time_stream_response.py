...
T = TypeVar("T", bound="LogsSearchOverTimeStreamResponse")


@_attrs_define
class LogsSearchOverTimeStreamResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logs_search_over_time_stream_response = cls(
            data=data,
            done=done,
            error=error,
            estimate=estimate,
        ...
        logs_search_over_time_stream_response.additional_properties = d
        return logs_search_over_time_stream_response
