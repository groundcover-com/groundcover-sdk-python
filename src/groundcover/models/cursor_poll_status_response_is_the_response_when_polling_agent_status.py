...
T = TypeVar("T", bound="CursorPollStatusResponseIsTheResponseWhenPollingAgentStatus")


@_attrs_define
class CursorPollStatusResponseIsTheResponseWhenPollingAgentStatus:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cursor_poll_status_response_is_the_response_when_polling_agent_status = cls(
        ...
        cursor_poll_status_response_is_the_response_when_polling_agent_status.additional_properties = d
        return cursor_poll_status_response_is_the_response_when_polling_agent_status
