...
T = TypeVar("T", bound="CurrentStatsRequest")


@_attrs_define
class CurrentStatsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        current_stats_request = cls(
            end=end,
            sources=sources,
            start=start,
        )

        current_stats_request.additional_properties = d
        return current_stats_request
