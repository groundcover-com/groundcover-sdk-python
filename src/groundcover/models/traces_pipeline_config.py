...
T = TypeVar("T", bound="TracesPipelineConfig")


@_attrs_define
class TracesPipelineConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traces_pipeline_config.additional_properties = d
        return traces_pipeline_config
