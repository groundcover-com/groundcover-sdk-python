...
from ..models.update_secret_request_managed_by_provider import UpdateSecretRequestManagedByProvider
...
class UpdateSecretRequest:
    """
    Attributes:
        content (str): The secret content (base64 encoded for binary data)
        name (str): The name of the secret
        type_ (str): The type of the secret (e.g., api_key, password, basic_auth)
        managed_by_provider (UpdateSecretRequestManagedByProvider | Unset): Indicates if this secret is managed by an
    ...
    name: str
    type_: str
    managed_by_provider: UpdateSecretRequestManagedByProvider | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        managed_by_provider: UpdateSecretRequestManagedByProvider | Unset
        if isinstance(_managed_by_provider, Unset) or _managed_by_provider is None:
            managed_by_provider = UNSET
        else:
            managed_by_provider = UpdateSecretRequestManagedByProvider(_managed_by_provider)
