...
T = TypeVar("T", bound="UpdateNotificationRouteRequest")


@_attrs_define
class UpdateNotificationRouteRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_notification_route_request = cls(
            name=name,
            query=query,
            routes=routes,
        ...
        update_notification_route_request.additional_properties = d
        return update_notification_route_request
