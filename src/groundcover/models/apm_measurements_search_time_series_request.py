...
T = TypeVar("T", bound="ApmMeasurementsSearchTimeSeriesRequest")


@_attrs_define
class ApmMeasurementsSearchTimeSeriesRequest:
    """
    Attributes:
        ...
        filters (str | Unset): Extra filters to apply on the measurements
        ...
        query (str | Unset): GCQL Query to filter measurements. Either `query` or `pipeline`
        ...
        sources (list[ConditionSpecifiesASearchConditionBasedOnAColumnAndFilters] | Unset): Sources to filter
            measurements
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        apm_measurements_search_time_series_request = cls(
            end=end,
            start=start,
        ...
        apm_measurements_search_time_series_request.additional_properties = d
        return apm_measurements_search_time_series_request
