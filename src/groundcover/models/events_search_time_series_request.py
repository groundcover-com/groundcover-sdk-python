...
T = TypeVar("T", bound="EventsSearchTimeSeriesRequest")


@_attrs_define
class EventsSearchTimeSeriesRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        events_search_time_series_request = cls(
            end=end,
            start=start,
        ...
        events_search_time_series_request.additional_properties = d
        return events_search_time_series_request
