...
class LogEntry:
    ...
    line_truncated: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if line_truncated is not UNSET:
            field_dict["lineTruncated"] = line_truncated
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        line_truncated = d.pop("lineTruncated", UNSET)
