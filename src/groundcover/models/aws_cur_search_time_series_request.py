...
T = TypeVar("T", bound="AwsCurSearchTimeSeriesRequest")


@_attrs_define
class AwsCurSearchTimeSeriesRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aws_cur_search_time_series_request = cls(
            end=end,
            start=start,
        ...
        aws_cur_search_time_series_request.additional_properties = d
        return aws_cur_search_time_series_request
