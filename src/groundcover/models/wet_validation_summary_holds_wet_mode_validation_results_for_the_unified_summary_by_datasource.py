...
T = TypeVar("T", bound="WetValidationSummaryHoldsWetModeValidationResultsForTheUnifiedSummaryByDatasource")


@_attrs_define
class WetValidationSummaryHoldsWetModeValidationResultsForTheUnifiedSummaryByDatasource:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        wet_validation_summary_holds_wet_mode_validation_results_for_the_unified_summary_by_datasource = cls()
        ...
        wet_validation_summary_holds_wet_mode_validation_results_for_the_unified_summary_by_datasource.additional_properties = additional_properties
        return wet_validation_summary_holds_wet_mode_validation_results_for_the_unified_summary_by_datasource
