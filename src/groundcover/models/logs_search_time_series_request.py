...
T = TypeVar("T", bound="LogsSearchTimeSeriesRequest")


@_attrs_define
class LogsSearchTimeSeriesRequest:
    """
    Attributes:
        ...
        filters (str | Unset): Extra filters to apply on the logs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logs_search_time_series_request = cls(
            end=end,
            start=start,
        ...
        logs_search_time_series_request.additional_properties = d
        return logs_search_time_series_request
