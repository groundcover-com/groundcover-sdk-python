...
T = TypeVar("T", bound="ListApisRequestsRequest")


@_attrs_define
class ListApisRequestsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_apis_requests_request = cls(
        ...
        list_apis_requests_request.additional_properties = d
        return list_apis_requests_request
