...
T = TypeVar("T", bound="BatchDashboardsRequest")


@_attrs_define
class BatchDashboardsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_dashboards_request = cls(
            dashboard_uuids=dashboard_uuids,
        )

        batch_dashboards_request.additional_properties = d
        return batch_dashboards_request
