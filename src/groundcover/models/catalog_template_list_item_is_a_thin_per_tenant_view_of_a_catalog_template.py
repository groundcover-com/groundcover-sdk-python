...
T = TypeVar("T", bound="CatalogTemplateListItemIsAThinPerTenantViewOfACatalogTemplate")


@_attrs_define
class CatalogTemplateListItemIsAThinPerTenantViewOfACatalogTemplate:
    ...
    dashboard's UUID.
        ...
        Attributes:
            ...
            installed_dashboard_id (str | Unset):
    ...
    installed_dashboard_id: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        installed_dashboard_id = self.installed_dashboard_id
        ...
        if installed_dashboard_id is not UNSET:
            field_dict["installedDashboardId"] = installed_dashboard_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        installed_dashboard_id = d.pop("installedDashboardId", UNSET)
        ...
        catalog_template_list_item_is_a_thin_per_tenant_view_of_a_catalog_template = cls(
            added=added,
            catalog_id=catalog_id,
            description=description,
            detection=detection,
            display_name=display_name,
            installed_dashboard_id=installed_dashboard_id,
        ...
        catalog_template_list_item_is_a_thin_per_tenant_view_of_a_catalog_template.additional_properties = d
        return catalog_template_list_item_is_a_thin_per_tenant_view_of_a_catalog_template
