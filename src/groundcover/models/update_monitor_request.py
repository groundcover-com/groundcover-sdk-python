...
from ..models.update_monitor_request_execution_error_state import UpdateMonitorRequestExecutionErrorState
from ..models.update_monitor_request_measurement_type import UpdateMonitorRequestMeasurementType
from ..models.update_monitor_request_no_data_state import UpdateMonitorRequestNoDataState
...
if TYPE_CHECKING:
    ...
    from ..models.update_monitor_request_annotations import UpdateMonitorRequestAnnotations
    from ..models.update_monitor_request_labels import UpdateMonitorRequestLabels


T = TypeVar("T", bound="UpdateMonitorRequest")
...
class UpdateMonitorRequest:
    ...
    Attributes:
        ...
        annotations (UpdateMonitorRequestAnnotations | Unset): Annotations to attach to the alert.
        ...
        no_data_state (UpdateMonitorRequestNoDataState | Unset): State to enter if no data is returned.
    ...
    title: str
    annotations: UpdateMonitorRequestAnnotations | Unset = UNSET
    ...
    no_data_state: UpdateMonitorRequestNoDataState | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotations: UpdateMonitorRequestAnnotations | Unset
        if isinstance(_annotations, Unset) or _annotations is None:
            annotations = UNSET
        else:
            annotations = UpdateMonitorRequestAnnotations.from_dict(_annotations)
        ...
        execution_error_state: UpdateMonitorRequestExecutionErrorState | Unset
        ...
        labels: UpdateMonitorRequestLabels | Unset
        if isinstance(_labels, Unset) or _labels is None:
            labels = UNSET
        else:
            labels = UpdateMonitorRequestLabels.from_dict(_labels)

        _measurement_type = d.pop("measurementType", UNSET)
        measurement_type: UpdateMonitorRequestMeasurementType | Unset
        if isinstance(_measurement_type, Unset) or _measurement_type is None:
            measurement_type = UNSET
        else:
            measurement_type = UpdateMonitorRequestMeasurementType(_measurement_type)
        ...
        no_data_state: UpdateMonitorRequestNoDataState | Unset
        if isinstance(_no_data_state, Unset) or _no_data_state is None:
            no_data_state = UNSET
        else:
            no_data_state = UpdateMonitorRequestNoDataState(_no_data_state)
        ...
        update_monitor_request.additional_properties = d
        return update_monitor_request
