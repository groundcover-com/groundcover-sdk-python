...
T = TypeVar("T", bound="ListApisErrorsResponse")


@_attrs_define
class ListApisErrorsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_apis_errors_response = cls(
            velocities=velocities,
        )

        list_apis_errors_response.additional_properties = d
        return list_apis_errors_response
