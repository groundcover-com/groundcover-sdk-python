...
T = TypeVar("T", bound="IngestionMeasurementsSearchRequest")


@_attrs_define
class IngestionMeasurementsSearchRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ingestion_measurements_search_request = cls(
            end=end,
            start=start,
            filters=filters,
            pipeline=pipeline,
        ...
        ingestion_measurements_search_request.additional_properties = d
        return ingestion_measurements_search_request
