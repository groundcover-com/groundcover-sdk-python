...
T = TypeVar("T", bound="LogsInsightsRequestParams")


@_attrs_define
class LogsInsightsRequestParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logs_insights_request_params = cls(
        ...
        logs_insights_request_params.additional_properties = d
        return logs_insights_request_params
