...
T = TypeVar("T", bound="AssetGapDetailKeysByMetric")


@_attrs_define
class AssetGapDetailKeysByMetric:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        asset_gap_detail_keys_by_metric = cls()
        ...
        asset_gap_detail_keys_by_metric.additional_properties = additional_properties
        return asset_gap_detail_keys_by_metric
