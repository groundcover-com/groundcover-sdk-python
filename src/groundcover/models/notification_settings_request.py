...
T = TypeVar("T", bound="NotificationSettingsRequest")
...
class NotificationSettingsRequest:
    """
    Attributes:
        disable_renotification (bool | Unset): Disable re-notifications entirely Example: True.
        renotification_interval (str | Unset): The interval between re-notifications (e.g., "4h", "30m") Example: 4h.
    """
