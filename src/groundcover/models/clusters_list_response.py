...
if TYPE_CHECKING:
    from ..models.clusters_list_result import ClustersListResult


T = TypeVar("T", bound="ClustersListResponse")
...
class ClustersListResponse:
    """
    Attributes:
        clusters (list[ClustersListResult] | Unset):
        total_count (int | Unset):
    """

    clusters: list[ClustersListResult] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _clusters is not UNSET:
            ...
            for clusters_item_data in _clusters:
                clusters_item = ClustersListResult.from_dict(clusters_item_data)

                clusters.append(clusters_item)

        total_count = d.pop("totalCount", UNSET)

        clusters_list_response = cls(
            clusters=clusters,
            total_count=total_count,
        )

        clusters_list_response.additional_properties = d
        return clusters_list_response
