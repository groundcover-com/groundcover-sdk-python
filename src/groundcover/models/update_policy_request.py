...
class UpdatePolicyRequest:
    ...
    Attributes:
        ...
        claim_role (str | Unset): Optional new claim role for the policy.
        current_revision (int | Unset): The current revision number of the policy being updated (for optimistic
            locking).
