...
T = TypeVar("T", bound="ListApisLatenciesRequest")


@_attrs_define
class ListApisLatenciesRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_apis_latencies_request = cls(
        ...
        list_apis_latencies_request.additional_properties = d
        return list_apis_latencies_request
