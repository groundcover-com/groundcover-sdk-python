...
T = TypeVar("T", bound="IssuesSearchTimeSeriesRequest")


@_attrs_define
class IssuesSearchTimeSeriesRequest:
    """
    Attributes:
        ...
        fill_value (float | Unset): Value used to fill empty time buckets in the response. When omitted, empty buckets
            are filled with null.
        filters (str | Unset): Extra filters to apply on the issues
        ...
        query (str | Unset): GCQL Query to filter issues
        sources (list[ConditionSpecifiesASearchConditionBasedOnAColumnAndFilters] | Unset): Sources to filter issues
        value_field (str | Unset): ValueField selects the numeric column(s) to project as time series.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        issues_search_time_series_request = cls(
            end=end,
            start=start,
        ...
        issues_search_time_series_request.additional_properties = d
        return issues_search_time_series_request
