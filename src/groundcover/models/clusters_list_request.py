...
T = TypeVar("T", bound="ClustersListRequest")


@_attrs_define
class ClustersListRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clusters_list_request = cls(
            sources=sources,
        )

        clusters_list_request.additional_properties = d
        return clusters_list_request
