...
T = TypeVar("T", bound="PolicyWithEntityCountIncludesThePolicyDetailsAlongWithTheCountOfEntitiesItsAppliedTo")


@_attrs_define
class PolicyWithEntityCountIncludesThePolicyDetailsAlongWithTheCountOfEntitiesItsAppliedTo:
    """
    Attributes:
        ...
        entity_count (int | Unset): Number of entities (users/service accounts) this policy is applied to.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if entity_count is not UNSET:
            field_dict["entityCount"] = entity_count
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_count = d.pop("entityCount", UNSET)

        policy_with_entity_count_includes_the_policy_details_along_with_the_count_of_entities_its_applied_to = cls(
            name=name,
        ...
        policy_with_entity_count_includes_the_policy_details_along_with_the_count_of_entities_its_applied_to.additional_properties = d
        return policy_with_entity_count_includes_the_policy_details_along_with_the_count_of_entities_its_applied_to
