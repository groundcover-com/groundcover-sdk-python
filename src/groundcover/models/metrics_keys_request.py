...
T = TypeVar("T", bound="MetricsKeysRequest")


@_attrs_define
class MetricsKeysRequest:
    """
    Attributes:
        end (datetime.datetime | Unset): End specifies the end time for the metric keys query.
        filter_ (str | Unset): Filter specifies a search filter to apply to the metric keys.
        limit (int | Unset): Limit specifies the maximum number of results to return.
        name (str | Unset): Name specifies the metric name to get keys for.
        sources (list[ConditionSpecifiesASearchConditionBasedOnAColumnAndFilters] | Unset): Sources specifies the
            sources to filter the metric keys.
        start (datetime.datetime | Unset): Start specifies the start time for the metric keys query.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metrics_keys_request.additional_properties = d
        return metrics_keys_request
