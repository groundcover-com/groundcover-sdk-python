...
class CreateWorkflowResponse:
    ...
    Attributes:
        ...
        status (str | Unset): Current status of the workflow
        workflow_id (str | Unset): Unique identifier for the created workflow
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_workflow_response.additional_properties = d
