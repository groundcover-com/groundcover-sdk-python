...
if TYPE_CHECKING:
    from ..models.notification_settings_response import NotificationSettingsResponse
    from ..models.route_rule_response import RouteRuleResponse


T = TypeVar("T", bound="NotificationRouteResponse")


@_attrs_define
class NotificationRouteResponse:
    """
    Attributes:
        ...
        notification_settings (NotificationSettingsResponse | Unset):
        query (str | Unset): The gcQL query Example: env:prod AND severity:critical.
        routes (list[RouteRuleResponse] | Unset): The routing rules
    """
    ...
    notification_settings: NotificationSettingsResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_notification_settings, Unset) or _notification_settings is None:
            ...
            notification_settings = NotificationSettingsResponse.from_dict(_notification_settings)
        ...
        notification_route_response = cls(
        ...
        notification_route_response.additional_properties = d
        return notification_route_response
