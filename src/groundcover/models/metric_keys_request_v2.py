...
T = TypeVar("T", bound="MetricKeysRequestV2")


@_attrs_define
class MetricKeysRequestV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metric_keys_request_v2.additional_properties = d
        return metric_keys_request_v2
