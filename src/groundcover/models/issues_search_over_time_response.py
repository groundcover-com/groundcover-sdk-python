...
T = TypeVar("T", bound="IssuesSearchOverTimeResponse")


@_attrs_define
class IssuesSearchOverTimeResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        issues_search_over_time_response = cls(
            data=data,
        )

        issues_search_over_time_response.additional_properties = d
        return issues_search_over_time_response
