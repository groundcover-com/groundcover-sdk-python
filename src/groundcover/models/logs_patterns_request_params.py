...
T = TypeVar("T", bound="LogsPatternsRequestParams")


@_attrs_define
class LogsPatternsRequestParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logs_patterns_request_params = cls(
            end=end,
            start=start,
        ...
        logs_patterns_request_params.additional_properties = d
        return logs_patterns_request_params
