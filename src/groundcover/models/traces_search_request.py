...
T = TypeVar("T", bound="TracesSearchRequest")


@_attrs_define
class TracesSearchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traces_search_request.additional_properties = d
        return traces_search_request
