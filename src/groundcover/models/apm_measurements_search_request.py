...
T = TypeVar("T", bound="ApmMeasurementsSearchRequest")


@_attrs_define
class ApmMeasurementsSearchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        apm_measurements_search_request = cls(
            end=end,
            start=start,
            filters=filters,
            pipeline=pipeline,
        ...
        apm_measurements_search_request.additional_properties = d
        return apm_measurements_search_request
