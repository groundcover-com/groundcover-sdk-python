...
T = TypeVar("T", bound="TraceDetailsResponseInfo")


@_attrs_define
class TraceDetailsResponseInfo:
    """
    Attributes:
        body (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trace_details_response_info = cls(
            body=body,
        ...
        trace_details_response_info.additional_properties = d
        return trace_details_response_info
