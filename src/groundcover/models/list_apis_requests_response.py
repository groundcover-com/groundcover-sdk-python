...
T = TypeVar("T", bound="ListApisRequestsResponse")


@_attrs_define
class ListApisRequestsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_apis_requests_response = cls(
            velocities=velocities,
        )

        list_apis_requests_response.additional_properties = d
        return list_apis_requests_response
