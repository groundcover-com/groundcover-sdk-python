...
T = TypeVar("T", bound="GetEventMetadataRequest")
...
class GetEventMetadataRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_event_metadata_request = cls(
        ...
        get_event_metadata_request.additional_properties = d
        return get_event_metadata_request
