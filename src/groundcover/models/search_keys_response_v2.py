...
if TYPE_CHECKING:
    from ..models.key_item import KeyItem


T = TypeVar("T", bound="SearchKeysResponseV2")


@_attrs_define
class SearchKeysResponseV2:
    """
    Attributes:
        done (bool | Unset):
        is_limit_reached (bool | Unset):
        keys (list[KeyItem] | Unset):
    """

    done: bool | Unset = UNSET
    is_limit_reached: bool | Unset = UNSET
    keys: list[KeyItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _keys is not UNSET:
            ...
            for keys_item_data in _keys:
                keys_item = KeyItem.from_dict(keys_item_data)

                keys.append(keys_item)

        search_keys_response_v2 = cls(
            done=done,
            is_limit_reached=is_limit_reached,
            keys=keys,
        )

        search_keys_response_v2.additional_properties = d
        return search_keys_response_v2
