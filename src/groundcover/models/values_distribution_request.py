...
T = TypeVar("T", bound="ValuesDistributionRequest")


@_attrs_define
class ValuesDistributionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        values_distribution_request = cls(
            end=end,
            start=start,
        ...
        values_distribution_request.additional_properties = d
        return values_distribution_request
