...
generate:
	@echo "Generated code is produced in the groundcover monorepo and refreshed"
	@echo "on each release via .github/workflows/release.yml. It is not generated here."
