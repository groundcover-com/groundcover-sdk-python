...
> **Note:** The generated API client (`src/groundcover/api`, `src/groundcover/models`)
> is committed to this repository and refreshed automatically on each release from the
> [groundcover monorepo](https://github.com/groundcover-com/groundcover-private). It is
> not generated locally here.
